...
class PrivateRecipeTestApi(TestCase):
    ...
    def test_create_recipe_with_tags(self):
        ...
        payload = {
            'title': 'Avacado time cheese cake',
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        ...
        recipe1 = sample_recipe(user=self.user, title="The vegetable biryani")
        recipe2 = sample_recipe(user=self.user, title="vegetable bath")
        tag1 = sample_tag(user=self.user, name="vegan")
        tag2 = sample_tag(user=self.user, name="veggies")
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title="chicken biryani")
    ...
    def test_filter_recipes_by_ingridents(self):
        """Test returning recipes with specific ingridents"""
        recipe1 = sample_recipe(user=self.user, title="chicken pizza")
        recipe2 = sample_recipe(user=self.user, title="chicken pastha")
        ...
        recipe3 = sample_recipe(user=self.user, title="mushroom manchurian")
