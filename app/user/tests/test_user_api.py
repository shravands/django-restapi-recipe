...
class PublicUserApiTests(TestCase):
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test@app.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_create_token_invalid_creadentials(self):
        ...
        create_user(email='test@app.com', password='testpass')
        payload = {'email': 'test@app.com', 'password': 'wrong'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_no_user(self):
        """Test that token is not created if user dosent exists"""
        payload = {'email': 'test@app.com', 'password': 'testpass'}
        res = self.client.post(TOKEN_URL, payload)
    ...
    def test_create_token_missing_field(self):
        ...
        payload = {'email': 'test@app.com', 'password': ''}
        res = self.client.post(TOKEN_URL, payload)
